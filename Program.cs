...
// Реализация интерфейса выглядит, как 
// наследование от него "класс / стркутура : интерфейс" как и при наследовании, к приватным
// элементам, мы доступ получить не можем. Если члены интерфейса не имеют модификатора, по
// умолчанию, они public(публичны), т.к. цель интерфейсов, определение функционала, для 
// реализации его классом или структурой. Тем не менее, начиная с .NET 8, мы можем явно указать
// модификаторы доступа


using System.Dynamic;

Console.WriteLine(Iinterface._lol);

interface Iinterface {
    public int Lol {get;}
    private const int _lol = 34;
}
